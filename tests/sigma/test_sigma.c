...
main(int argc, char** argv)
{
    ...
    if (cfilt_sigma_generator_alloc(CFILT_SIGMA_VAN_DER_MERWE, &generator, N, ALPHA, BETA, KAPPA))
    {
        fprintf(stderr, "Could not allocate memory for the Van Der Merwe sigma generator\n");
        return -1;
    }
